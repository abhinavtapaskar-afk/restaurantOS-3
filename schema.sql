...
DROP POLICY IF EXISTS "Owners can update their menu images." ON storage.objects;
CREATE POLICY "Owners can update their menu images."
ON storage.objects FOR UPDATE
USING ( auth.uid() = owner AND bucket_id = 'menu-images' );

DROP POLICY IF EXISTS "Owners can delete their menu images." ON storage.objects;
